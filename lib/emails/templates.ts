...
<body class="body" style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #ffffff !important; color: #111827 !important; -webkit-text-size-adjust: 100%;">
  ...
  bookingConfirmation: (date: Date, sessionsRemaining: number, rescheduleUrl?: string, cancelUrl?: string, endTime?: Date) => {
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #ffffff !important; color: #111827 !important; -webkit-text-size-adjust: 100%;">
  ...
  ownerBookingNotification: (customerEmail: string, customerName: string | null, date: Date, type: 'new' | 'reschedule' | 'cancel', endTime?: Date) => {
    const typeLabels = {
    ...
    return {
      subject: `${subject}${isBackToBack ? ' (Back-to-Back)' : ''} - ${customerName || customerEmail}`,
      html: `
<!DOCTYPE html>
<html>
<head>
