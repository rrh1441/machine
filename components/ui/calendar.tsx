  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        selected: "bg-club-green text-white hover:bg-club-green hover:text-white focus:bg-club-green focus:text-white",
        today: "bg-club-cream text-club-green font-semibold",
